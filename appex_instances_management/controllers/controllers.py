...
class AppexInstancesManagement(Controller):
    ...
    def create_instance(self, **kw):
        ...
        instance_obj = request.env['odoo.instances.management'].with_user(user).create({'partner_id': partner_obj.id, 'country_id': country_obj.id})
    ...
    def stop_instance(self, **kw):
        instance_obj = request.env['odoo.instances.management'].with_user(SUPERUSER_ID).search([('name', '=', kw.get('instance_id'))])
